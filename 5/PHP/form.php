  ...
  ?>
   ...
   <div class="fon1 tab mt-4 mb-4 shadow rounded" id="quf">
       ...
       value="<?php echo htmlspecialchars($values['names']); ?>" placeholder="Введите ФИО" />
         ...
         <div class="form_item form-group">
    <label for="formTel" style="color: black;">Телефон:</label><br>
    <input name="phone" class="group <?php echo $errors['phone'] ? 'error' : ''; ?>" value="<?php echo htmlspecialchars($values['phone']); ?>" placeholder="Введите номер телефона" />
</div>
<div class="form_item form-group">
