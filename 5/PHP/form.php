...
<body>
  ...
  <div class="container">
    ...
    <form action="" method="POST">
      ...
      <br>
      Телефон:<br><input type="tel" name="phone" <?php if (!empty($errors['phones'])) {print 'class="group error"';} else print 'class="group"'; ?> value="<?php print isset($values['phones']) ? htmlspecialchars($values['phones']) : ''; ?>">
      <br>
      E-mail:
      ...
      <select class="group" name="languages[]" size="10" multiple>
        <option value="Pascal" <?php if (isset($values['language']) && in_array("Pascal", $values['language'])) {print 'selected';} ?>>Pascal</option>
        <option value="C" <?php if (isset($values['language']) && in_array("C", $values['language'])) {print 'selected';} ?>>C</option>
        <option value="C_plus_plus" <?php if (isset($values['language']) && in_array("C_plus_plus", $values['language'])) {print 'selected';} ?>>C++</option>
        <option value="JavaScript" <?php if (isset($values['language']) && in_array("JavaScript", $values['language'])) {print 'selected';} ?>>JavaScript</option>
        <option value="PHP" <?php if (isset($values['language']) && in_array("PHP", $values['language'])) {print 'selected';} ?>>PHP</option>
        <option value="Python" <?php if (isset($values['language']) && in_array("Python", $values['language'])) {print 'selected';} ?>>Python</option>
        <option value="Java" <?php if (isset($values['language']) && in_array("Java", $values['language'])) {print 'selected';} ?>>Java</option>
        <option value="Haskel" <?php if (isset($values['language']) && in_array("Haskel", $values['language'])) {print 'selected';} ?>>Haskel</option>
        <option value="Clojure" <?php if (isset($values['language']) && in_array("Clojure", $values['language'])) {print 'selected';} ?>>Clojure</option>
        <option value="Prolog" <?php if (isset($values['language']) && in_array("Prolog", $values['language'])) {print 'selected';} ?>>Prolog</option>
      </select>
      <br>
